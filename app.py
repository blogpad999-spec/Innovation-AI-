...
# Custom CSS to make it look professional and highly responsive on mobile
st.markdown("""
    <style>
    .main-title {
        font-size: 2.5rem;
...
# =====================================================================
# Securely fetching API Key. For local testing, you can replace with your actual key string: "AIzaSy..."
...
if submit_button:
    if not app_idea.strip():
        ...
        with st.spinner("✨ Innovation AI is architecture-planning and coding your application..."):
            try:
                # Constructing a structured prompt to get both documentation and working HTML code
                prompt = f"""
                ...
                # Requesting response from Gemini 1.5 Flash (Optimized for speed and long context)
                ...
                # Add a download feature for ease of use on mobile devices
                st.download_button(
